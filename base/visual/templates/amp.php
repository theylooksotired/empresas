...
<head>
    ...
    <style amp-custom><?php echo str_replace('../../img/', ASTERION_BASE_URL.'visual/img/', str_replace('../fonts/icomoon', ASTERION_BASE_URL.'visual/css/fonts/icomoon', file_get_contents(ASTERION_BASE_FILE.'visual/css/stylesheets/public.css')));?></style>
